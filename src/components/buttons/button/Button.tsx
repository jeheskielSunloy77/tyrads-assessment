...
const buttonStyles = {
	variant: {
		solid: {
			primary:
				'bg-primary-500 text-white hover:bg-primary-600 focus:ring-primary-500 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-500',
			secondary:
		...
		outline: {
			primary:
				'border-2 border-gray-200 text-primary-500 hover:text-white hover:bg-primary-500 hover:border-primary-500 dark:border-gray-700 dark:hover:border-primary-500',
			secondary:
		...
		ghost: {
			primary:
				'border-transparent text-primary-500 hover:bg-primary-100 focus:ring-primary-500',
			secondary:
